...
public class ErrorCode {
    ...
    public static final String VIDEO_LIBRARY_ERROR_INVALID_STATE = "ERROR-VIDEO-LIBRARY-ERROR-0005";
    public static final String VIDEO_LIBRARY_SUBTITLE_ERROR_NOT_FOUND = "ERROR-VIDEO-LIBRARY-SUBTITLE-0000";
    public static final String VIDEO_LIBRARY_SUBTITLE_ERROR_INVALID_REQUEST = "ERROR-VIDEO-LIBRARY-SUBTITLE-0001";
    public static final String VIDEO_LIBRARY_SUBTITLE_ERROR_LANGUAGE_EXISTED = "ERROR-VIDEO-LIBRARY-SUBTITLE-0002";
